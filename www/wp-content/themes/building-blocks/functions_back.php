...
update_option('siteurl', 'http://318376.engline.web.hosting-test.net/');
update_option('home', 'http://318376.engline.web.hosting-test.net/');
...
function add_global_custom_options(){   
	add_menu_page('Преподаватели', 'Преподаватели', 'manage_options', 'functions','global_custom_options');
...
function add_sub_menu(){
	add_submenu_page('Управление', 'Управление','manage_options', 'manage', 'none');
}
