$(window).load(function(){
    ...
    $('.payment h2.trigger:first').addClass('active'); //добавляем класс .active к первому блоку
    $('.payment .toggle_container:not(:first)').hide(); // оставляем открытым первый блок
 
    $('.payment h2.trigger').click(function() {
